...
function lap() {
    if (time_ele.innerHTML == '00:00:00'){
           
    }else{
        console.log(time_ele.innerHTML)
        ctr++;
        const h3 =document.createElement('h3')
        h3.textContent="Lap "+ ctr+ ":  " + time_ele.innerHTML 
        const m=document.getElementById("lapping")
        console.log(m)
        m.appendChild(h3)
...
function reset() {
    ...
    let v=document.getElementsByTagName('h3')
    for (let each of v){
        each.innerHTML=""
    }
}